...
public class SmallGreenTree : Monster
{
    [Header("³ª¹«")]
    [SerializeField] private CircleCollider2D playerCheckColl;
    [SerializeField] private GroundCheck groundCheck;
    [SerializeField] private ThornsAttack thornsAttack;
    ...
    {
        ThornsAttack thornsSc = Instantiate(thornsAttack);
        thornsSc.PlayerPos = _playerController.transform.position;
        yield return null;
